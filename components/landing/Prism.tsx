...
type PrismProps = {
  ...
  timeScale?: number;
  colorSaturation?: number; // Added to control monochrome/color intensity
};
...
const Prism: React.FC<PrismProps> = ({
  ...
  inertia = 0.05,
  bloom = 1,
  suspendWhenOffscreen = true, // Better for performance
  timeScale = 0.5,
  colorSaturation,
}) => {
  ...
  useEffect(() => {
    ...
    const dpr = 1; // Forced to 1 to drastically improve performance on raymarching
    ...
    const fragment = /* glsl */ `
      ...
      void main(){
        ...
        const int STEPS = 30; // Reduced from 100 for massive performance boost
