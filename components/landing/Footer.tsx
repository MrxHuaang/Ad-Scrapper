...
type FooterProps = {
  /** Only menu / legal / social / copyright—no full-viewport hero or CTAs. */
  compact?: boolean;
};
...
export function Footer({ compact = false }: FooterProps) {
  return (
    <footer
      ...
      className={
        compact
          ? "relative box-border w-full flex-col overflow-hidden bg-black scroll-mt-20 md:scroll-mt-24"
          : "zl-footer-viewport relative box-border flex flex-col overflow-hidden bg-black scroll-mt-20 md:scroll-mt-24"
      }
    >
      {!compact && (
        <>
      ...
      <div
        className={
          compact
            ? "relative z-10 w-full shrink-0 border-t border-white/[0.08]"
            : "relative z-10 w-full shrink-0 border-t border-white/[0.06]"
        }
      >
