...
export function HeroSection() {
  return (
    <section className="relative flex h-dvh min-h-[640px] items-center overflow-x-clip">
      {/* ── Pure black base ── */}
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 hidden w-[58%] md:block"
        style={{
          background:
            "linear-gradient(to right, black 52%, transparent 100%)",
        }}
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6 lg:px-8">
        <div className="max-w-xl">
          ...
          >
            <a
              href="#product"
              className="group inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.05] px-4 py-1.5 text-xs text-[#a1a1a1] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md transition-all duration-200 hover:border-white/[0.14] hover:bg-white/[0.09] hover:text-white hover:shadow-[0_0_40px_-16px_var(--zl-spectrum-glow)]"
            >
              ...
              Airworthiness compliance, automated
              <span className="text-[10px] text-white/40 transition-transform duration-200 group-hover:translate-x-0.5">
                ›
              </span>
            </a>
          </motion.div>
          ...
          >
            ...
            <br />
            {/* Gradient text */}
            <span className="italic zl-text-spectrum">for aviation.</span>
          </motion.h1>
          ...
          >
            ...
            <a
              href="#product"
              className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full border border-white/[0.12] bg-white/[0.06] px-6 py-3 text-sm text-[#a1a1a1] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md transition-all duration-300 hover:border-white/[0.18] hover:bg-white/[0.09] hover:text-white hover:shadow-[0_0_36px_-20px_var(--zl-spectrum-glow)] active:scale-[0.97]"
            >
              <span
          ...
          <motion.div
            ...
            className="mt-10 flex items-center gap-3 text-xs text-[#737373]"
          >
            <span className="flex items-center gap-1.5">
              <span className="text-[#00ff94]">✓</span> 21,450+ ADs indexed
            </span>
            <span className="h-3 w-px bg-white/10" />
            <span className="flex items-center gap-1.5">
              <span className="text-[#00ff94]">✓</span> Updated daily
            </span>
            <span className="h-3 w-px bg-white/10" />
            <span className="flex items-center gap-1.5">
              <span className="text-[#00ff94]">✓</span> 4 authorities
            </span>
          </motion.div>
        </div>
      </div>
