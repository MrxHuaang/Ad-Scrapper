...
import { CircleHelp, Globe, LogOut, Sparkles, Settings, User, ArrowUpRight } from "lucide-react";
        ...
        {open && (
          ...
          >
            ...
            <button
              ...
              className="flex w-full cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] text-white/45 transition-colors hover:bg-white/[0.04] hover:text-white/80"
            >
            ...
            <button
              ...
              onClick={() => {
                ...
                else showToast("Language settings coming soon", "info");
              }}
              className="flex w-full cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] text-white/45 transition-colors hover:bg-white/[0.04] hover:text-white/80"
            >
            ...
            <button
              type="button"
              className="flex w-full cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] text-white/45 transition-colors hover:bg-white/[0.04] hover:text-white/80"
              onClick={() => showToast("Account page coming soon", "info")}
            >
